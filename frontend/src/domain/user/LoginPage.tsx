    ...
    <div className="bg-gray-100 min-h-screen flex items-start justify-center pt-24 px-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <h3 className="text-2xl font-bold text-center mb-4">SOFIA</h3>
            ...
            <div className="grid grid-cols-3 gap-3 mt-4">
              {[1,2,3,4,5,6,7,8,9].map((n) => (
                <button
                  ...
                  className="h-14 rounded-xl text-xl font-bold text-blue-900 disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 transition-all bg-blue-100"
                >
                  {n}
                </button>
              ))}
              <button
                ...
                className="h-14 rounded-xl text-xl disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 transition-all bg-orange-100 text-orange-900"
              >
                ⌫
              </button>
              <button
              ...
              <button
                ...
                onClick={clearPw}
                disabled={isLoading || password.length === 0}
                className="h-14 rounded-xl text-xl disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 transition-all bg-red-100 text-red-900"
              >
                ✕
              </button>
            </div>
