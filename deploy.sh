...
echo "  [4/4] jskn Tomcat으로 전송      ($JSKN:$REMOTE_WEBAPPS/sofia.war)"
echo ""
...
put $WAR_FILE $REMOTE_WEBAPPS/sofia.war
EOF

echo ""
echo "=== 배포 완료 ==="
echo "접속: http://jskn.iptime.org/sofia/"
echo "API:  http://jskn.iptime.org/sofia/health"
